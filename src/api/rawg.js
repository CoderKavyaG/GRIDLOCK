...
export const rawg = {
    heroGames: () => `${BASE}/games?ordering=-rating&metacritic=90,100&page_size=3&key=${KEY}`,
    trending: () => `${BASE}/games?ordering=-added&page_size=6&key=${KEY}`,
    topRated: () => `${BASE}/games?ordering=-rating&metacritic=90,100&page_size=6&key=${KEY}`,
    newReleases: () => `${BASE}/games?ordering=-released&page_size=5&key=${KEY}`,
    byGenre: (slug) => `${BASE}/games?genres=${slug}&ordering=-rating&page_size=6&key=${KEY}`,
    ...
    explore: (params) => {
        let url = `${BASE}/games?key=${KEY}&page_size=12`;
    ...
    topGames: () => `${BASE}/games?ordering=-rating,-added&page_size=30&key=${KEY}`
};
